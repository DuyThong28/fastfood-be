...
export const OrderRejected = ({ order, userName }: OrderSuccessProps) => {
  return (
    <Html>
      <Head />
      <Preview>
      ...
      <Body style={main}>
        <h1 style={title}>BOOKNOW - Đơn hàng của bạn đã bị hủy bởi hệ thống</h1>
        <p style={paragraph}>Hi {userName},</p>
        <p style={paragraph}>
          Fastfood xin chân thành cảm ơn bạn vì đã quan tâm. Đơn đặt hàng của
          bạn đã bị hủy . Dưới đây là chi tiết đơn hàng của bạn:
        </p>
        <p style={paragraph}>
